...
from .const import (
    ...
    CONF_AZURE_OPENAI_PATH,
    CONF_AZURE_OPENAI_VALIDATE_MODEL,
    CONF_CONTEXT_LENGTH,
    CONF_BATCH_SIZE,
    CONF_THREAD_COUNT,
    ...
    DEFAULT_AZURE_OPENAI_VALIDATE_MODEL,
...
class ConfigFlow(BaseLlamaConversationConfigFlow, config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def _async_validate_azure_openai(self, user_input: dict) -> tuple:
        ...
        return await self._async_validate_generic_openai(user_input)
